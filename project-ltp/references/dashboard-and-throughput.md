...
The server binds to `127.0.0.1:8765`, serves only the bundled frontend and the
two known YAML files, and is read-only. It polls file metadata so model changes
